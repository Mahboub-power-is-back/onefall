...
<pre><code>apt install -y wget screen && wget -q https://raw.githubusercontent.com/Mahboub-power-is-back/onefall/refs/heads/main/main.sh && chmod +x main.sh && screen -S install ./main.sh</code></pre>
or ( ipv4 + ipv6 )
